...
\COPY  RoomType_temp(RMTYPEID,NAME,SHORTNAME) FROM './dbf/roomtype.csv' WITH (FORMAT csv,DELIMITER ',', ENCODING 'UTF8');
...
\COPY  Room_temp(ROOMID,ROOMGUID,HOUSEGUID,REGIONCODE,FLATNUMBER,FLATTYPE,ROOMNUMBER,ROOMTYPE,CADNUM,ROOMCADNUM,POSTALCODE,UPDATEDATE,PREVID,NEXTID,OPERSTATUS,STARTDATE,ENDDATE,LIVESTATUS,NORMDOC) FROM './dbf/room.csv' WITH (FORMAT csv,DELIMITER ',', ENCODING 'UTF8');
